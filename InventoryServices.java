...
public class InventoryServices {
	...
	public static Map<String, Object> checkReceivedDateAndTime(DispatchContext dctx, Map<String, ? extends Object> context) {
		...
		if(currentTimestamp.compareTo(receivedTime) < 0 ){
			result.put("canPick", "No");
		}
		else
			result.put("canPick", "Yes");
